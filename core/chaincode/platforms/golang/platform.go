...
import (
	...
	"github.com/slava-balahontsev/bcnex/core/chaincode/platforms/util"
...
func (goPlatform *Platform) GetDeploymentPayload(spec *pb.ChaincodeSpec) ([]byte, error) {
	...
	var provided = map[string]bool{
		"github.com/slava-balahontsev/bcnex/core/chaincode/shim": true,
		"github.com/slava-balahontsev/bcnex/protos/peer":         true,
	}
