...
func TestPlatform_GoPathNotSet(t *testing.T) {
	...
	spec := &pb.ChaincodeSpec{
		ChaincodeId: &pb.ChaincodeID{
			Path: "/opt/gopath/src/github.com/slava-balahontsev/bcnex",
		},
	}
...
func Test_findSource(t *testing.T) {
	...
	source, err = findSource(gopath, "github.com/slava-balahontsev/bcnex/peer")
	if err != nil {
		t.Errorf("failed to find source: %s", err)
	}

	if _, ok := source["src/github.com/slava-balahontsev/bcnex/peer/main.go"]; !ok {
...
func Test_DeploymentPayload(t *testing.T) {
	...
	spec := &pb.ChaincodeSpec{
		ChaincodeId: &pb.ChaincodeID{
			Path: "github.com/slava-balahontsev/bcnex/examples/chaincode/go/chaincode_example02",
		},
	}
...
func Test_decodeUrl(t *testing.T) {
	cs := &pb.ChaincodeSpec{
		ChaincodeId: &pb.ChaincodeID{
			Name: "Test Chaincode",
			Path: "http://github.com/slava-balahontsev/bcnex/examples/chaincode/go/map",
		},
	}
...
func TestValidateSpec(t *testing.T) {
	...
	var tests = []struct {
		...
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "http://github.com/slava-balahontsev/bcnex/examples/chaincode/go/map"}}, succ: true},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "https://github.com/slava-balahontsev/bcnex/examples/chaincode/go/map"}}, succ: true},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/slava-balahontsev/bcnex/examples/chaincode/go/map"}}, succ: true},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/slava-balahontsev/bcnex/bad/chaincode/go/map"}}, succ: false},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: ":github.com/slava-balahontsev/bcnex/examples/chaincode/go/map"}}, succ: false},
	}
...
func TestGetDeploymentPayload(t *testing.T) {
	...
	var tests = []struct {
		...
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/slava-balahontsev/bcnex/examples/chaincode/go/map"}}, succ: true},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/slava-balahontsev/bcnex/examples/bad/go/map"}}, succ: false},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/slava-balahontsev/bcnex/test/chaincodes/BadImport"}}, succ: false},
	}
...
func TestGenerateDockerBuild(t *testing.T) {
	...
	specs := make([]spec, 0)
	specs = append(specs, spec{CCName: "NoCode", Path: "path/to/nowhere", File: "/bin/warez", Mode: 0100400, SuccessExpected: false})
	specs = append(specs, spec{CCName: "invalidhttp", Path: "https://not/a/valid/path", File: "/src/github.com/slava-balahontsev/bcnex/examples/chaincode/go/map/map.go", Mode: 0100400, SuccessExpected: false, RealGen: true})
	specs = append(specs, spec{CCName: "map", Path: "github.com/slava-balahontsev/bcnex/examples/chaincode/go/map", File: "/src/github.com/slava-balahontsev/bcnex/examples/chaincode/go/map/map.go", Mode: 0100400, SuccessExpected: true, RealGen: true})
	specs = append(specs, spec{CCName: "AutoVendor", Path: "github.com/slava-balahontsev/bcnex/test/chaincodes/AutoVendor/chaincode", File: "/src/github.com/slava-balahontsev/bcnex/test/chaincodes/AutoVendor/chaincode/main.go", Mode: 0100400, SuccessExpected: true, RealGen: true})
	specs = append(specs, spec{CCName: "mapBadPath", Path: "github.com/slava-balahontsev/bcnex/examples/chaincode/go/map", File: "/src/github.com/slava-balahontsev/bcnex/examples/bad/path/to/map.go", Mode: 0100400, SuccessExpected: false})
	specs = append(specs, spec{CCName: "mapBadMode", Path: "github.com/slava-balahontsev/bcnex/examples/chaincode/go/map", File: "/src/github.com/slava-balahontsev/bcnex/examples/chaincode/go/map/map.go", Mode: 0100555, SuccessExpected: false})
